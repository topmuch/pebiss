...
// This route handles /uploads/xxx.jpg WITHOUT middleware or rewrite
// Next.js standalone treats this as a regular route handler
export async function GET(
  ...
  try {
    ...
    // Coolify volume MUST be mounted at /app/uploads
